        ...
        <footer className="bg-slate-900 text-gray-300 py-6 mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Brand Section */}
                    <div>
                        <h2 className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-2">
                            Shivam's Blog
                        </h2>
                        <p className="text-sm text-gray-400">
                            A modern platform to share your thoughts, connect with others, and discover amazing content. 
                    ...
                    <div>
                        ...
                        <ul className="space-y-1">
                            ...
                            <li><a href="#" className="hover:text-blue-400 transition">Explore</a></li>
                ...
                <div className="border-t border-slate-800 mt-6 pt-4 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-sm text-gray-500">
                        &copy; {new Date().getFullYear()} Shivam's Blog. All rights reserved.
                    </p>
